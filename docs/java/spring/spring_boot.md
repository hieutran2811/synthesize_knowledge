...
> **Phạm vi canonical:** Trang này là overview trong learning path Java. Tài liệu chi tiết và được duy trì làm nguồn chính cho Spring Boot nằm tại [Spring Boot Core](../../springboot/springboot_core.md) và [roadmap Spring Boot](../../springboot/roadmap.md).
