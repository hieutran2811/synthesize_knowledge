---
title: "Roadmap – SQL Server Knowledge"
topic: sqlserver
level: mixed
...
- [SQL Server Backup & Recovery](administration/backup_recovery.md)
- [SQL Server High Availability & Disaster Recovery](administration/ha_dr.md)
- [SQL Server Security](administration/security.md)
- [SQL Server Architecture & Storage Engine](fundamentals/architecture.md)
- [SQL Server Indexing & Execution Plans](fundamentals/indexing.md)
- [SQL Server Transactions, Locking & Isolation](fundamentals/transactions.md)
- [T-SQL Advanced](fundamentals/tsql_advanced.md)
- [SQL Server Glossary](glossary.md)
- [Data Movement, CDC & Integration](integration/data_movement.md)
- [SQL Server từ Java: JDBC, Spring Boot & JPA](integration/jdbc_java.md)
- [SQL Server 2025: JSON gốc, Regex, Vector/AI & Optimized Locking](modern/sqlserver_2025.md)
- [SQL Server Monitoring & Troubleshooting](performance/monitoring_troubleshooting.md)
- [Table Partitioning & Quản lý bảng rất lớn](performance/partitioning.md)
- [SQL Server Query Optimization](performance/query_optimization.md)
- [SQL Server trên Linux, Docker & Kubernetes](platform/linux_containers.md)
- [Tổng Hợp Kiến Thức SQL Server](sqlserver_knowledge.md)
