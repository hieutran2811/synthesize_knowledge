---
title: "Roadmap Tổng Hợp Kiến Thức WebSocket – Cơ Bản đến Nâng Cao"
topic: websocket
level: mixed
...
- [Glossary WebSocket](glossary.md)
- [WebSocket Fundamentals – Giao thức & Nền tảng](websocket_fundamentals.md)
- [WebSocket Real-world Patterns](websocket_patterns.md)
- [WebSocket Reliability](websocket_reliability.md)
- [WebSocket Scaling & Security](websocket_scaling_security.md)
- [WebSocket Server Implementations](websocket_server.md)
