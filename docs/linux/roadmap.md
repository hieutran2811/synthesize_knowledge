---
title: "Roadmap Tổng Hợp Kiến Thức Linux"
topic: linux
level: mixed
review_status: needs_review
content_updated: 2026-05-09
last_verified: null
...
- [Backup & Recovery – Linux](admin/backup_recovery.md)
- [Performance Tuning – Linux](admin/performance_tuning.md)
- [Security Hardening – Linux](admin/security_hardening.md)
- [systemd Deep Dive](admin/systemd.md)
- [Disk & Storage Deep Dive – Linux](commands/disk_storage.md)
- [File Management Advanced – Deep Dive](commands/file_management.md)
- [Networking Deep Dive – Linux](commands/networking.md)
- [Process & Resource Management Advanced – Deep Dive](commands/process_management.md)
- [Text Processing Advanced – Deep Dive](commands/text_processing.md)
- [Docker Internals – Linux Layer](containers/docker_internals.md)
- [Namespaces & cgroups – Container Primitives](containers/namespaces_cgroups.md)
- [Glossary Linux](glossary.md)
- [Tổng Hợp Kiến Thức Linux](linux_knowledge.md)
- [Bash Advanced – Deep Dive](scripting/bash_advanced.md)
- [Bash Scripting Deep Dive – Basics](scripting/bash_basics.md)
- [Script Patterns – Production Best Practices](scripting/script_patterns.md)
