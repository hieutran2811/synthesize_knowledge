---
title: "Spring Boot Core *(phần lõi)* & Internals *(cơ chế bên trong)*"
topic: springboot
level: mixed
...
> **Nguồn canonical:** Đây là tài liệu chính cho Spring Boot core/application. Trang [Spring Boot trong Java learning path](../java/spring/spring_boot.md) chỉ đóng vai trò overview và phải liên kết về cụm này khi nội dung trùng phạm vi.
