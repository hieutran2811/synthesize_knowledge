---
title: "Roadmap Tổng Hợp Kiến Thức Angular – Cơ Bản đến Nâng Cao"
topic: angular
level: mixed
...
- [Angular Animations – @angular/animations Deep Dive](angular_animations.md)
- [Angular CLI, Build Tooling & Nx Monorepo – Deep Dive](angular_cli_nx_monorepo.md)
- [Angular Components Advanced – Lifecycle, Change Detection, DI](angular_components_advanced.md)
- [Angular Fundamentals – Nền Tảng](angular_fundamentals.md)
- [Angular HTTP Communication – HttpClient Deep Dive](angular_http_communication.md)
- [Angular Material, CDK & Accessibility – Deep Dive](angular_material_cdk_a11y.md)
- [Micro-Frontends, i18n, Feature Flags & Deployment – Deep Dive](angular_microfrontends_i18n.md)
- [Angular Performance & Production – Deep Dive](angular_performance_production.md)
- [Angular Routing & Forms – Deep Dive](angular_routing_forms.md)
- [RxJS in Angular – Reactive Programming](angular_rxjs.md)
- [Angular Security & Best Practices](angular_security_best_practices.md)
- [Angular Signals & Zoneless – Reactivity Model & Change Detection](angular_signals_zoneless.md)
- [Angular State Management – BehaviorSubject, NgRx, Signals](angular_state_management.md)
- [Angular Testing – Deep Dive (Unit, HTTP, Harness, Marble, E2E)](angular_testing.md)
- [Glossary Angular](glossary.md)
