...
- [API Design – thiết kế hợp đồng khó dùng sai](advanced/api_design.md)
- [Distributed Transactions – giữ đúng dữ liệu qua nhiều ranh giới](advanced/distributed_transactions.md)
- [Event-Driven Architecture – thiết kế hệ thống xoay quanh sự kiện](advanced/event_driven_architecture.md)
- [Microservices – chia hệ thống theo ranh giới nghiệp vụ](advanced/microservices.md)
- [Case Studies – Foundational (URL Shortener, Distributed ID, Rate Limiter)](case_studies/foundational_designs.md)
- [Case Studies – Platform (Object Storage, Typeahead, Payment, Notification)](case_studies/platform_designs.md)
- [Case Studies – Real-time & Scale (News Feed, Chat, Proximity/Geo)](case_studies/realtime_scale_designs.md)
- [Availability & Reliability – Sẵn sàng và tin cậy](fundamentals/availability_reliability.md)
- [Caching – Chiến lược cache](fundamentals/caching.md)
- [Database Design – Chọn và mở rộng tầng dữ liệu](fundamentals/databases_design.md)
- [Distributed Systems Theory – Nền tảng lý thuyết](fundamentals/distributed_systems_theory.md)
- [Interview Framework & Capacity Estimation – Phương pháp giải bài](fundamentals/interview_framework_estimation.md)
- [Load Balancing – Cân bằng tải](fundamentals/load_balancing.md)
- [Networking & Communication Protocols](fundamentals/networking_protocols.md)
