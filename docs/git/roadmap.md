---
title: "Roadmap Tổng Hợp Kiến Thức Git"
topic: git
level: mixed
...
- [Tổng Hợp Kiến Thức Git – Quy Trình Dự Án & Quản Lý Version Release](git_knowledge.md)
- [Glossary Git](glossary.md)
- [Release Management – Quy Trình Phát Hành, Hotfix & Rollback](versioning/release_management.md)
- [Semantic Versioning, Conventional Commits & Changelog](versioning/semantic_versioning.md)
- [Branching Strategies – Chiến Lược Nhánh Trong Dự Án Thực Tế](workflow/branching_strategies.md)
- [Team Collaboration – Pull Request, Code Review & Hợp Nhất Trong Nhóm](workflow/team_collaboration.md)
